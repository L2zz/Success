...
const site = "https://www.skku.edu/skku/campus/skk_comm/notice03.do"
const getHtml = async() => {
  try {
...
getHtml().then(html => {
  ...
  var lastRef = db.ref("site/0/category/2/last");
  var lastId;
  lastRef.once('value').then(function(snapshot) {
    ...
    var articleRef = db.ref("site/0/category/2/article").push();
