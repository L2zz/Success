...
const site = "https://skb.skku.edu/liberal/community/total_notice.do"
...
getHtml().then(html => {
  ...
  var lastRef = db.ref("site/4/category/0/last");
  var lastId;
  lastRef.once('value').then(function(snapshot) {
    ...
    for (var i=0; i<ulList.length; i++) {
      ...
      var articleRef = db.ref("site/4/category/0/article").push();
